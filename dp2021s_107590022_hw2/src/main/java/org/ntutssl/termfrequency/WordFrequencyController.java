...
public class WordFrequencyController {
    ...
    public WordFrequencyController(IOHandler handler, IStopWordManager swm, IDataStorageManager dsm, IWordFrequencyManager wfm){
    ...
    public void run(String order, Integer range, String outputPath){
        ...
        wfm.output(outputPath, order, range, ioHandler);
    }
}